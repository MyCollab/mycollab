...
public class AccountDefaultDynaFormLayoutFactory {
    ...
    static {
        ...
        accountSection.addField(new TextDynaFieldBuilder().fieldName("accountname")
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_ACCOUNT_NAME))
                .customField(false).fieldIndex(0).mandatory(true)
                .required(true).build());
        accountSection.addField(new TextDynaFieldBuilder().fieldName("phoneoffice")
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_OFFICE_PHONE))
                .customField(false).fieldIndex(1).build());

        accountSection.addField(new TextDynaFieldBuilder().fieldName("website").fieldIndex(2)
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_WEBSITE))
                .customField(false).build());

        accountSection.addField(new PhoneDynaFieldBuilder().fieldName("fax").fieldIndex(3)
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_FAX))
                .customField(false).build());

        accountSection.addField(new IntDynaFieldBuilder().fieldName("numemployees").fieldIndex(4)
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_EMPLOYEES))
                .customField(false).build());

        accountSection.addField(new PhoneDynaFieldBuilder().fieldName("alternatephone").fieldIndex(5)
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_OTHER_PHONE))
                .customField(false).build());

        accountSection.addField(new PickListDynaFieldBuilder<String>().fieldName("industry").fieldIndex(6)
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_INDUSTRY))
                .customField(false).build());

        accountSection.addField(new EmailDynaFieldBuilder().fieldName("email").fieldIndex(7)
        ...
        accountSection.addField(new TextDynaFieldBuilder().fieldName("assignuser").fieldIndex(10)
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_ASSIGNEE))
                .customField(false).build());

        accountSection.addField(new TextDynaFieldBuilder().fieldName("annualrevenue").fieldIndex(11)
        ...
        DynaSection addressSection = new DynaSectionBuilder().layoutType(LayoutType.TWO_COLUMN)
                ...
                .orderIndex(1).build();
        addressSection.addField(new TextDynaFieldBuilder().fieldIndex(0).fieldName("billingaddress")
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_BILLING_ADDRESS))
                .customField(false).build());
        addressSection.addField(new TextDynaFieldBuilder().fieldIndex(1).fieldName("shippingaddress")
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_SHIPPING_ADDRESS))
                .customField(false).build());
        addressSection.addField(new TextDynaFieldBuilder().fieldIndex(2).fieldName("city")
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_BILLING_CITY))
                .customField(false).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldIndex(3).fieldName("shippingcity")
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_SHIPPING_CITY))
                .customField(false).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldIndex(4).fieldName("state")
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_BILLING_STATE))
                .customField(false).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldIndex(5).fieldName("shippingstate")
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_SHIPPING_STATE))
                .customField(false).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldIndex(6).fieldName("postalcode")
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_BILLING_POSTAL_CODE))
                .customField(false).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldIndex(7).fieldName("shippingpostalcode")
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_SHIPPING_POSTAL_CODE))
                .customField(false).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldIndex(8).fieldName("billingcountry")
                .displayName(AppContext.getMessage(AccountI18nEnum.FORM_BILLING_COUNTRY))
                .customField(false).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldIndex(9).fieldName("shippingcountry")
        ...
        descSection.addField(new TextDynaFieldBuilder().fieldIndex(0).fieldName("description").customField(false)

...
@ViewComponent
public class TaskGroupAddViewImpl extends AbstractEditItemComp<SimpleTaskList> implements TaskGroupAddView {
    ...
    protected String initFormTitle() {
        return (beanItem.getId() != null) ? beanItem.getName() : AppContext.getMessage(TaskGroupI18nEnum.M_VIEW_NEW_TITLE);
    }

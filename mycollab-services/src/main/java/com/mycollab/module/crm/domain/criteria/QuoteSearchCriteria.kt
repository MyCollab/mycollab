 ...
 * @since 1.0
 */
class QuoteSearchCriteria : SearchCriteria() {
    ...
    var billingAccountName: StringSearchField? = null

    var billingContactName: StringSearchField? = null

    var shippingAccountName: StringSearchField? = null

    var shippingContactName: StringSearchField? = null

    var contractId: NumberSearchField? = null

		...
		<div id="body" >
			...
			<div id="mainBody">
				...
				<div>
					<table>
					 	<tr>
					 		<td style="width: 350px; vertical-align:top; padding-top:12px;font-size: 18px">招待を受諾していただきありがとうございます！MyCollabに新規登録の場合は、パスワードを入力してください：</td>
					 		<td style="width: 400px; display: inline-block; vertical-align: top;">
								<div id="mainContent">
					  				 <div>
										...
										<tbody>
										<tr>
											<td style="padding-top:8px;"><label for="password"><span style="font-size:14px">パスワード:</span></label></td>
										</tr>
										<tr>
									...
									<div style="padding-top: 15px; padding-left:200px;">
										<button style="width:80px;" class="v-button v-button-orangebtn" type="button" onclick="return createAccount();"><span style="font-family: 'verdana';font-size: 15px;">保存</span></button>&nbsp&nbsp&nbsp
										<button style="width:80px;" class="v-button v-button-graybtn" type="button" onclick="return cancel();"><span style="font-family: 'verdana';font-size: 15px;">キャンセル</span></button>
									</div>
								</div>
							</td>
					 	</tr>

...
public class CrmToolbar extends HorizontalLayout implements PageView {
    ...
    public CrmToolbar() {
        ...
        boolean isActivityEnable = AppContext.canRead(RolePermissionCollections.CRM_MEETING) ||
                AppContext.canRead(RolePermissionCollections.CRM_TASK) || AppContext.canRead(RolePermissionCollections.CRM_CALL);
    ...
    private class NavigatorItemListener implements Button.ClickListener {
        ...
        public void buttonClick(final ClickEvent event) {
            ...
            if (AppContext.getMessage(CrmCommonI18nEnum.TOOLBAR_DASHBOARD_HEADER).equals(caption)) {
                EventBusFactory.getInstance().post(new CrmEvent.GotoHome(this, null));
                selectedBtnCaption = caption;
            } else if (AppContext.getMessage(AccountI18nEnum.BUTTON_NEW_ACCOUNT).equals(caption)) {
            ...
            } else if (AppContext.getMessage(CrmCommonI18nEnum.TOOLBAR_ACCOUNTS_HEADER).equals(caption)) {
            ...
            } else if (AppContext.getMessage(CrmCommonI18nEnum.TOOLBAR_CAMPAIGNS_HEADER).equals(caption)) {
            ...
            } else if (AppContext.getMessage(CrmCommonI18nEnum.TOOLBAR_CASES_HEADER).equals(caption)) {
            ...
            for (Iterator<com.vaadin.ui.Component> it = CrmToolbar.this.iterator(); it.hasNext(); ) {
    ...
    private void gotoItem(String crmItem) {
        for (Iterator<com.vaadin.ui.Component> it = this.iterator(); it.hasNext(); ) {

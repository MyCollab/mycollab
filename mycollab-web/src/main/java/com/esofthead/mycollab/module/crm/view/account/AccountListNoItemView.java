...
public class AccountListNoItemView extends AbstractPageView{
	...
	public AccountListNoItemView() {
		...
		Label title = new Label("Maintance Your Accounts");
		...
		Button btCreateContact = new Button("Create Account", new Button.ClickListener() {
			private static final long serialVersionUID = 1L;
		...
		Button btImportContact = new Button("Import Accounts", new Button.ClickListener() {
			private static final long serialVersionUID = 1L;

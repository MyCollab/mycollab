 ...
 * 
 */
public class OpportunityHistoryLogList extends HistoryLogComponent {
	...
	public OpportunityHistoryLogList() {
		super(ModuleNameConstants.CRM, CrmTypeConstants.OPPORTUNITY);
	}

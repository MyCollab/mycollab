...
object RoleTableFieldDef {
    ...
    @JvmField
    val rolename = GridFieldMeta(GenericI18Enum.FORM_NAME, "rolename", WebUIConstants.TABLE_EX_LABEL_WIDTH)

    @JvmField
    val isDefault = GridFieldMeta(RoleI18nEnum.FORM_IS_DEFAULT, "isdefault", WebUIConstants.TABLE_M_LABEL_WIDTH)

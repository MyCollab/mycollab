...
<body style="height: 100%; margin: 0; padding: 0; width: 100%;">
	<div id="container" style="height:100%;">
		...
		<div id="body" style="background-color: rgb(239, 239, 239); height: 100%;">
			...
			<div id="mainBody">
				<div id="title">
					<p><span style="color: #196893; font: 22px 'Monda', sans-serif;">User has denied</span></p>
				</div>
				<hr size="1">
				...
				<div style="padding-left:670px; padding-top:20px;">
					<button style="width:100px;" class="v-button-bluebtn" type="button" onclick="return login();"><span style="font-family: 'verdana';font-size: 16px;">Take a look</span></button>
				</div>
			</div>
			<div id="bottom">
			    <p>
